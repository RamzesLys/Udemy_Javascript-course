...
function calc() {
  ...
  if(localStorage.getItem('sex')) {
    ...
    sex = 'female';
    localStorage.setItem('sex', 'female'); // якщо немає то встановлюємо у значення female та записуємо у Local Storage
  }
  ...
  if(localStorage.getItem('ratio')) {
   ratio = localStorage.getItem('ratio');
    ...
    ratio = 1.375;
    localStorage.setItem('ratio', 1.375); // якщо немає то встановлюємо у значення 1.375 та записуємо у Local Storage
  }
    ...
    elements.forEach(elem => {
      elem.addEventListener('click', (e) => {
        if (e.target.getAttribute('data-ratio')) {
          ...
          // записуємо коефіцієнт активності у LocaL Storage
  ...
  function getDinamicInformation (selector) {
    ...
    input.addEventListener('input', () => {
      ...
      //використовуємо регулярні вирази для перевірки значень, введених в input
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2023-11-09');
